...
.. admonition:: EXAMPLE 
    ...
    **Complexity:**
    ...
    1. **Time Complexity**  The Chandy-Lamport :ref:`Algorithm <Raymond>` takes at most O(D) time units to complete where D is ...
    2. **Message Complexity:** The Chandy-Lamport :ref:`Algorithm <Raymond>` requires 2|E| control messages.
